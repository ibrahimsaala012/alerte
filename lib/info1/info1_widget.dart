import '../create_accounte/create_accounte_widget.dart';
...
class Info1Widget extends StatefulWidget {
  const Info1Widget({Key key}) : super(key: key);

  @override
  _Info1WidgetState createState() => _Info1WidgetState();
}
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          'En cas de situation d\'urgence, vous pouvez alerter vos proches en toute simplicité ',
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .subtitle2
                                              .override(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CreateAccounteWidget(),
                        ),
                      );
                    },
                    text: 'C\'est parti !',
